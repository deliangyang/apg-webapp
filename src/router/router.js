...
export const routers = [
  { path: '/', component: HomePage, props: { active: 0 }},
  ...
  { path: '/product/category/:id', component: () => import('@/module/product/category.vue') },
  ...
  { path: '/user/index', component: () => import('@/module/user/index.vue') },
  { path: '/user/feedback', component: () => import('@/module/user/feedback.vue') },
];
